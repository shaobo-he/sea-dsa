; RUN: not %seadsa %s %ci_dsa --sea-dsa-wf-strict --sea-dsa-wf-max-collapsed-live-nodes=1 --sea-dsa-wf-max-collapsed-access-ratio=100 2>&1 | OutputCheck %s -d --comment=";" --check-prefix=EXPLICIT
...
; EXPLICIT: explicit sea_dsa_collapse calls 1
; EXPLICIT: SeaDsa well-formedness check failed
; ALLOW: explicit sea_dsa_collapse calls 1
